...
async function seed() {
  try {
    ...
    const transportPhone = "6260491554";
    ...
    console.log("-> Use phone 7458947838 with OTP 123456 to login as Garage.");
    console.log("-> Use phone 6260491554 with OTP 123456 to login as Transport.");
    process.exit(0);
  } catch (e) {
