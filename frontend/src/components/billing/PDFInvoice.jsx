...
const styles = StyleSheet.create({
  page: { padding: '240pt 25pt 210pt 25pt', fontSize: 10, color: '#000', fontFamily: 'Helvetica' },
      ...
      {itemChunks.map((chunk, pageIndex) => (
        <Page key={pageIndex} size="A4" style={styles.page}>
          ...
          <View fixed style={{ position: 'absolute', bottom: 25, left: 25, right: 25 }}>
            ...
            <Text style={{ textAlign: 'center', fontSize: 7, color: '#999', marginTop: 10 }} render={({ pageNumber, totalPages }) => `Page ${pageNumber} of ${totalPages}`} />
          </View>
        </Page>
      ))}
    </Document>
