            ...
            <div style={{ minWidth: 0 }}>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <input 
                  ...
                  style={{ width: '100%', minWidth: 0, boxSizing: 'border-box', height: 42, padding: '8px 10px 8px 34px', borderRadius: 12, border: '1px solid #E2E8F0', fontSize: '0.85rem', fontWeight: 700, background: 'white', color: '#1E293B', outline: 'none' }} 
                />
              </div>
            </div>
            <div style={{ minWidth: 0 }}>
